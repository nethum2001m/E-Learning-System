    ...
    return (
        <div className="min-h-screen bg-gray-100 py-8 px-4">
            <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl p-8">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    {q.options.map((opt, optIndex) => (
                                        <label
                                            key={optIndex}
                                            className="flex items-center space-x-3 p-3 border border-gray-300 rounded-lg cursor-pointer hover:border-blue-400 transition"
                                        >
                                            <input
                                                type="radio"
                ...
                {result && (
                    <div className=" p-6 rounded-2xl bg-green-100 text-green-700 border border-green-300 text-center text-lg font-medium shadow-md">
